...
/** btn color **/
.tm-btn.color-key.tm-active,
.tm-btn.color-key.tm-hover{color: #FFFFFF !important;border-color: "color" !important;background-color: "color" !important;}
@media (hover: hover) {
	.tm-btn.color-key:hover{color: #FFFFFF !important;border-color: "color" !important;background-color: "color" !important;}
}
/** btn background color **/
.tm-btn.bg-key.tm-active,.tm-btn.bg-key.tm-hover{border-color: "activeColor" !important;background-color: "activeColor" !important;}
@media (hover: hover) {
	.tm-btn.bg-key:hover{border-color: "activeColor" !important;background-color: "activeColor" !important;}
}
.tm-btn.active-color-key.tm-active,.tm-btn.active-color-key.tm-hover{background-color: #FFFFFF !important;border-color: "color" !important;color: "color" !important;}
@media (hover: hover) {
	.tm-btn.active-color-key:hover{background-color: #FFFFFF !important;border-color: "color" !important;color: "color" !important;}
}
.tm-btn.active-bg-key.tm-active,.tm-btn.active-bg-key.tm-hover{color: #FFFFFF !important;background-color: "color" !important;border-color: "color" !important;}
@media (hover: hover) {
	.tm-btn.active-bg-key:hover{color: #FFFFFF !important;background-color: "color" !important;border-color: "color" !important;}
}

/** link color **/
.tm-link.color-key.tm-active,.tm-link.color-key.tm-hover{color: "color";background-color: transparent;border-bottom-color: "color";}
@media (hover: hover) {
	.tm-link.color-key:hover{color: "color";background-color: transparent;border-bottom-color: "color";}
}
.tm-link.active-color-key.tm-active,.tm-link.active-color-key.tm-hover{color: "color" !important;background-color: transparent !important;border-bottom-color: "color" !important;}
@media (hover: hover) {
	.tm-link.active-color-key:hover{color: "color" !important;background-color: transparent !important;border-bottom-color: "color" !important;}
}
